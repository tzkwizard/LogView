    ...
    function datasearch(common, client, $http) {
        ...
        function termQueryAggragation(indices, type, aggfield, size, start, end) {
            ...
            var info =
          {
            ...
            return $http.post("https://microsoft-apiapp463245e7d2084cb79dbc3d162e7b94cb.azurewebsites.net/api/ElasticAggragation/TermQuery", ii)
        ...
        function stringQuery(indices, type, pagecount, searchText, start, end) {
            ...
            /*$http.get("https://microsoft-apiapp463245e7d2084cb79dbc3d162e7b94cb.azurewebsites.net/query/GetSampledata")
                .success(function (resp) {
                    toastr.info(resp);
                    return resp;
                }).error(function (e)   {
            ...
            return $http.post("https://microsoft-apiapp463245e7d2084cb79dbc3d162e7b94cb.azurewebsites.net/api/ElasticSearch", ii)
              .success(function (resp) {
                  toastr.info(resp);
                  return resp;
              }).error(function (e) {
